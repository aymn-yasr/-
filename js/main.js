// js/main.js
import { loadComponent, createAndShowPrivateChatDialog, createUserInfoModal, updatePrivateButtonNotification, hideUserInfoModal } from './chat-ui.js';
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        await loadComponent("input-bar", "components/input-bar.html");
                ...
                if (chatUserId) {
            await sendJoinMessage(currentRoomId);
        }
